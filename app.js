...
recognition.onresult = function (event) {
  ...
  if (transcript.includes("hello") || transcript.includes("hello")){
    readOut("hello sir")
  }
  ...
  if (transcript.includes("how many languages you know")){
    readOut("for now 2 languages, english and russian, but coming years i will learn more languages")
  }
  ...
  if (transcript.includes(" i use you")){
    readOut("you can use me from my owner's website")
    window.open("https://mrabdullokh.uz/")
  }
